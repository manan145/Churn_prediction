...
def main():
    ...
    st.markdown("""
     :dart:  We have created this Streamlit app for predicting those customers who churn for a telecommunication company. This application can be used for both online prediction and batch data prediction. \n
    """)
